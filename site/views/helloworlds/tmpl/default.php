...
<div id="helloworlds-helloworlds">
	<?php foreach($this->items as $item): ?>
		<?php
		$item->selectcategory = $db->setQuery('SELECT #__categories.title FROM #__categories WHERE #__categories.id = "'.$item->selectcategory.'"')->loadResult();
		if(empty($item->alias)):
		...
		<p><strong>Select Category</strong>: <?php echo $item->selectcategory; ?></p>
