...
class HelloworldsModelhelloworld extends JModelAdmin
{
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		return JFactory::getUser()->authorise('core.edit', 'com_helloworlds.message.'. ((int) isset($data[$key]) ? $data[$key] : 0)) or parent::allowEdit($data, $key);
	}
	...
	{
		return 'administrator/components/com_helloworlds/models/forms/helloworld.js';
	}
